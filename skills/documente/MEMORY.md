...
- **Workflow Legacy** (paths sans `/subjects/`, depuis 2026-05-04 v2.3)
  ...
  - Phase L0 = proposition systématique de migration vers subject pool
...
- **Phase L0 — pas de proposition migration sur dossiers figés** : skills sans cycle de vie évolutif, tools sans état évolutif. Proposer uniquement sur dossiers où le contenu évolue dans le temps.
